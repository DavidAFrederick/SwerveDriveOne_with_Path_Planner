...
class TunerConstants:
    ...
    _steer_gains = (
        ...
        .with_k_p(90)    # Updated per the videos
        .with_k_i(0)
        .with_k_d(0.2)
        .with_k_s(0.1)
        .with_k_v(1.5)
    ...
    # This needs to be tuned to your individual robot
    speed_at_12_volts: units.meters_per_second = 9.85
    ...
    _front_left_encoder_offset: units.rotation = 0.08056640625
    ...
    _front_right_steer_motor_id = 9
    _front_right_encoder_id = 8
    _front_right_encoder_offset: units.rotation = -0.04736328125
    ...
    _back_left_encoder_offset: units.rotation = -0.158203125
    ...
    _back_right_encoder_offset: units.rotation = 0.489990234375
